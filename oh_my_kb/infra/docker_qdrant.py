...
Manages a single ``oh-my-kb-qdrant`` container: pull image, create,
...
Typical usage::
    ...
    qc = QdrantContainer(name="oh-my-kb-qdrant", image="qdrant/qdrant:latest", port=6333)
...
class QdrantContainer:
    ...
    Args:
        name: Docker container name (e.g. ``"oh-my-kb-qdrant"``).
