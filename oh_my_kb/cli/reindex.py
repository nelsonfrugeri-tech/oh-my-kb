...
Mirrors the pattern established by :class:`oh_my_kb.cli.installer.Installer`:
...
:mod:`oh_my_kb.agents.bootstrap` to keep the CLI reindex logic self-contained
...
from oh_my_kb.cli.config import CLIConfig, UniverseNotFoundError, load_config
from oh_my_kb.embedding import Embedder
from oh_my_kb.services import Indexer, ReindexReport, reindex_universe
...
class ReindexRunner:
    ...
    config_loader:
        ...
        :func:`oh_my_kb.cli.config.load_config` so production use is seamless.
    """
